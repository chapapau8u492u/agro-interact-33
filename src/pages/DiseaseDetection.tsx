      ...
      <div className="container px-6">
        ...
        <Card className="mt-8">
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                { crop: "Tomato", disease: "Early Blight", date: "2 hours ago", severity: "Medium" },
                { crop: "Wheat", disease: "Rust Disease", date: "1 day ago", severity: "High" },
                { crop: "Rice", disease: "Healthy", date: "2 days ago", severity: "Low" }
              ].map((item, index) => (
